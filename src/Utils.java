...
public final class Utils implements Serializable {
    ...
    public static ArrayList<ArrayList<Integer>> generate_random_binary_numbers(int k, int max_num, Random generator) {
        ...
        for (int i=0; i < max_num; i++) {
            int current_num = getRandomNumber(generator, num_strings_int);
    ...
    public static int getRandomNumber(Random generator, int max) {
        Integer random = generator.nextInt(max);
        return random;
    }
    ...
    public static int matrix_index_of_array(int[][] matrix, int[] item) {
        ...
        System.out.println("couldn't match function");
        return -1;
    }
