...
//        res = res * att_avg;
    ...
    boolean attractor_exists(LinkedHashSet<ArrayList<Integer>> attractor) {
        ...
        ArrayList<Integer> first_attractor_state = it.next();
        ArrayList<Integer> current_network_state = update_state(first_attractor_state);
        while (it.hasNext()) {
            ArrayList<Integer> current_attractor_state = it.next();
            if (!current_attractor_state.equals(current_network_state)) {
                return false;
            }
            current_network_state = update_state(current_attractor_state);
        }
        return first_attractor_state.equals(current_network_state);
    }
